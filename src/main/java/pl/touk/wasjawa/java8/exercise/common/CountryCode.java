package pl.touk.wasjawa.java8.exercise.common;
 ...
 * codes. There are instance methods to getOrCache the country name ({@link #getName()}), the
 ...
 * In addition, there are static methods to getOrCache a CountryCode instance that
